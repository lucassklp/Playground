...
using GettingStartedMachineLearningML.Model.DataModels;
using Microsoft.ML.Trainers;

namespace GettingStartedMachineLearningML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\simas\Documents\Git\Playground\getting-started-ml-net\GettingStartedMachineLearning\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../GettingStartedMachineLearningML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.SgdCalibrated(new SgdCalibratedTrainer.Options() { L2Regularization = 1E-05f, ConvergenceTolerance = 1E-05f, NumberOfIterations = 10, Shuffle = false, LabelColumnName = "Sentiment", FeatureColumnName = "Features" });
